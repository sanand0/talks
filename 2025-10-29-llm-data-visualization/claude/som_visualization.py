...
def train_som(X, som_shape=(10, 10), sigma=1.5, learning_rate=0.5, 
              num_iterations=1000):
    """
...
def visualize_som_results(som, X, df, feature_cols, output_file='som_visualization.png'):
    ...
    plt.title('True Customer Segments\nSOM Discovers These Naturally!', 
              fontsize=12, fontweight='bold')
    plt.axis('equal')
...
def main():
    ...
    # Load data
    df, X_scaled, feature_cols, scaler = load_and_preprocess_data(
