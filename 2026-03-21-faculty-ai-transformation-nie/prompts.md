...
- [Claude chat](https://claude.ai/share/bf51a1c5-40cf-4d1e-a91d-a78468fac787) covering:
  - How to improve NIRF scores
    - ![NIE's NIRF Rank Trajectory](nie-nirf-ranking-trend-claude.webp)
  - What NIE's publications tell us about how to improve
  - How other data shared by NIE can be analyzed
- Feedback analysis
  - ![Faculty preparation has the highest correlation with overall learning - and impact of other factors](correlation-with-overall-learning.webp)
  - ![Lab related factors have the highest drop from the first year to the next cohort of 4th-6th semesters](cohort-gap.webp)
